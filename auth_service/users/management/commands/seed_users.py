...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--count", type=int, default=50, help="Number of users to create"
        )
        parser.add_argument(
            "--admin-count", type=int, default=2, help="Number of admin users to create"
        )
        ...
        with transaction.atomic():
                    ...
                    for _ in range(random.randint(1, 5)):
                        UserActivity.objects.create(
                            ...
                            action=random.choice(
                                ["login", "profile_update", "preferences_update"]
                            ),
            ...
            for i in range(admin_count):
                try:
                    ...
                    # Assign admin role
                    UserRole.objects.create(user=admin, role_name="admin")
    ...
    def handle(self, *args, **options):
        ...
        try:
            with transaction.atomic():
                ...
                # Assign admin role
                UserRole.objects.create(user=user, role_name="admin")
